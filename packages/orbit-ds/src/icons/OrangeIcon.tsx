  ...
  switch (variant) {
    case "regular":
      return (
        ...
        >
          ...
          />
          <path
            d="M128,72h0a56,56,0,0,1,56-56h8a56,56,0,0,1-56,56Z"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <path
            d="M128,72h0A56,56,0,0,0,72,16H64"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <path
            d="M176,160a49.52,49.52,0,0,1-40,40"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "bold":
      return (
        ...
        >
          ...
          />
          <path
            d="M166.17,164A40.11,40.11,0,0,1,140,190.17"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <circle cx={128} cy={152} r={80} opacity={0.2} />
          <circle
            cx={128}
            cy={152}
            r={80}
