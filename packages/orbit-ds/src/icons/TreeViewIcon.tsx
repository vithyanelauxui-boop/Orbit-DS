  ...
  switch (variant) {
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <rect x={56} y={24} width={48} height={48} rx={8} opacity={0.2} />
          <rect x={168} y={96} width={48} height={48} rx={8} opacity={0.2} />
          <rect x={168} y={184} width={48} height={48} rx={8} opacity={0.2} />
          <rect
            x={56}
            y={24}
            width={48}
