  ...
  switch (variant) {
    case "regular":
      return (
        ...
        >
          ...
          <path
            d="M200,77.65C189.86,51.29,168.57,32,128,32c-64,0-80,48-80,96s16,96,80,96c48,0,72-32,72-56,0-64-104-64-104-16,0,40,72,40,72-24,0-56-56-56-72-32"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <ellipse cx={128} cy={128} rx={80} ry={96} opacity={0.2} />
          <path
            d="M200,77.65C189.86,51.29,168.57,32,128,32c-64,0-80,48-80,96s16,96,80,96c48,0,72-32,72-56,0-64-104-64-104-16,0,40,72,40,72-24,0-56-56-56-72-32"
            fill="none"
            stroke="currentColor"
