  ...
  switch (variant) {
    case "regular":
      return (
        ...
        >
          ...
          />
          <path
            d="M24,224S139.52,32,77.91,32C32.07,32,31.58,225.11,128,104.19c0,0,8.11,39.44,27.23,39.81,7.72.15,17.25-6.31,28.77-24,0,0,0,24,48,24"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "bold":
      return (
        ...
        >
          ...
          />
          <path
            d="M24,224S139.6,32,78,32c-45.84,0-46.41,184.91,50,64,0,0,16,77.43,56,16,0,0,0,24,48,24"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <path d="M77.91,32h0Z" opacity={0.2} />
          <path
