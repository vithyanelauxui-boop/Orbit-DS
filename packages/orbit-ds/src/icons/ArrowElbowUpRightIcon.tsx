  ...
  switch (variant) {
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <polygon points="168 128 216 80 168 32 168 128" opacity={0.2} />
          <polygon
            points="168 128 216 80 168 32 168 128"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
