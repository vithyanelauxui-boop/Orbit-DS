    ...
    case "regular":
      return (
        ...
        >
          ...
          <path
            d="M167.83,98.79a48,48,0,1,1-23.9,71.65L160,224H96l16.07-53.56a48,48,0,1,1-23.9-71.65,48,48,0,1,1,79.66,0Z"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
    ...
    case "bold":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <path
            d="M105,178.82a48,48,0,1,1-16.87-80,48,48,0,1,1,79.66,0,48,48,0,1,1-16.87,80L160,224H96Z"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
