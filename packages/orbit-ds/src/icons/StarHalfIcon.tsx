    ...
    case "regular":
      return (
        ...
        >
          ...
          <path
            d="M224,113.15l5.06-4.36A8.46,8.46,0,0,0,224.27,94L216,93.29"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
          ...
          />
          <polyline
            points="184.44 168 180.37 150.78 192 140.75"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <path
            d="M176,218.61l6.72,4.13a8.4,8.4,0,0,0,12.52-9.17L193.92,208"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <path
            d="M176,90.07,160.36,88.8,135.74,29.2a8.36,8.36,0,0,0-15.48,0L95.64,88.8,31.73,94a8.46,8.46,0,0,0-4.79,14.83l48.7,42L60.76,213.57a8.4,8.4,0,0,0,12.52,9.17L128,189.09,139.24,196"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <path
            d="M120.26,29.2,95.64,88.8,31.73,94a8.46,8.46,0,0,0-4.79,14.83l48.7,42L60.76,213.57a8.4,8.4,0,0,0,12.52,9.17L128,189.09V24A8.26,8.26,0,0,0,120.26,29.2Z"
            opacity={0.2}
          />
          <line
            x1={128}
