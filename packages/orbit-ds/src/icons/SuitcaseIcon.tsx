    ...
    case "bold":
      return (
        ...
        >
          ...
          />
          <path
            d="M168,204V40a16,16,0,0,0-16-16H104A16,16,0,0,0,88,40V204"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <path
            d="M88,64V208H40a8,8,0,0,1-8-8V72a8,8,0,0,1,8-8Z"
            opacity={0.2}
          />
          <path
            d="M168,64V208h48a8,8,0,0,0,8-8V72a8,8,0,0,0-8-8Z"
            opacity={0.2}
          />
          <rect
            x={32}
