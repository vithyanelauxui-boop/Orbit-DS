    ...
    case "bold":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <path
            d="M72,216h36V172a20,20,0,0,1,20-20h0a20,20,0,0,1,20,20v44h36V104L128,72,72,104Z"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <polygon
            points="184 128 224 152 224 216 184 216 184 128"
            opacity={0.2}
          />
          <polygon points="72 128 32 152 32 216 72 216 72 128" opacity={0.2} />
          <path
            d="M72,216h40V168a16,16,0,0,1,16-16h0a16,16,0,0,1,16,16v48h40V104L128,72,72,104Z"
            fill="none"
            stroke="currentColor"
