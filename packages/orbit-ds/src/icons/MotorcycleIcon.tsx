  ...
  switch (variant) {
    case "regular":
      return (
        ...
        >
          ...
          />
          <path
            d="M16,80s47.31,18.34,72.56,29.81a24,24,0,0,0,25.16-3.18C121.64,100.09,134.4,96,152,96h64a64,64,0,0,0-61.65,46.75,23.83,23.83,0,0,1-23,17.25H40"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <circle cx={40} cy={160} r={32} opacity={0.2} />
          <circle cx={216} cy={160} r={32} opacity={0.2} />
          <circle
            cx={40}
            cy={160}
            r={32}
