  ...
  switch (variant) {
    ...
    case "bold":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <polygon
            points="60 64 24 184 96 184 60 64"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <polygon points="64 64 24 184 104 184 64 64" opacity={0.2} />
          <circle cx={156} cy={76} r={44} opacity={0.2} />
          <rect x={136} y={152} width={88} height={56} opacity={0.2} />
          <polygon
            points="64 64 24 184 104 184 64 64"
            fill="none"
            stroke="currentColor"
