  ...
  switch (variant) {
    ...
    case "duotone":
      return (
        ...
        >
          <rect width={256} height={256} fill="none" />
          <polygon points="136 168 88 216 40 168 136 168" opacity={0.2} />
          <polygon
            points="136 168 88 216 40 168 136 168"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
